...
<?php include('main-header.php');?>
  ...
  <div class="row">
    ...
    <h1 class="h3 mb-4 text-gray-800 ">Borang Minta </h1><br>
...
<div class="row">
    ...
    <div class="col-lg-6">
        ...
        <div class="card shadow mb-4">
            ...
            <h6 class="m-0 font-weight-bold text-primary">Borang Mahu Barang Perkongsian: Maklumat Diri Anda</h6>
            </div>
            <div>
            ...
            <div class="card-body">
                ...
                <p>Nota: Ini adalah borang maklumat tentang anda yang ingin berkongsi barang dengan jiran anda.
                </p>
            </a>
            <form action="sendContact-share.php?updateB=<?php echo $itemID?>" method="POST">
    ...
    <button class="btn btn-primary" name="updateB">Hantar</button>
    ...
    <div class="col-lg-6">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Barang Yang Anda Mahu</h6>
            </div>
            <div class="card">
            <div class="card-body">
            <img class="p-0 m-0 mx-auto w-70 rounded d-block" src="img/<?php echo $image; ?>" style="height:250px">
                ...
                <p class="card-text"><strong>Dikongsi Oleh: </strong>
                <a href="user-account-profile.php?GetID=<?php echo $userID?>" ><?php echo $name?></p></a>
                
                <p class="card-text"><strong>Dikongsi Pada: </strong><?php echo $date?></p>
