...
<section class="breadcrumbs">
  ...
  <div class="row mt-4">
           <?php 
          $query_r = mysqli_query($db, "SELECT * FROM requestitem INNER JOIN useraccounts ON requestitem.userID=useraccounts.userID WHERE itemCat='Bukan Makanan';");

          if(mysqli_num_rows($query_r) > 0){
            
            while ($row_r = mysqli_fetch_array($query_r)){
          $itemID_r = $row_r['itemID'];
                   ?>
                       <div class ="col-lg-3 col-md-4 col-sm-6 col-6">
                           <form method="post" action="">
                                       <div class="card">
                                           <div class="card-body">
                                             <img class="p-0 m-0 mx-auto w-100" src="img/<?php echo $row_r['image']; ?>" style="height:250px">
                                         
                                               <h5 class="card-title" style="text-align: center";><hr><strong><?php echo $row_r["itemName"];?></strong></hr></h5>
                                               <p class="card-text" style="text-align: center";><hr><strong>Deskripsi: </strong><br><?php echo $row_r["itemDesc"];?></br></hr></p>
                                               <p class="card-text"><strong>Kategori: </strong><br><?php echo $row_r["itemCat"];?></br></p>
                                               <p class="card-text"><strong>Diminta Oleh: </strong><br><?php echo $row_r["name"];?></br></p>
                                               <p class="card-text"><strong>Diminta Pada: </strong><br> <?php echo $row_r["date"];?></br></p>
                                              
                                               <div class="text-center">
                                               <a href="contactForm.php?GetID=<?php echo $itemID_r?>" class="text-light">
 ...
 <div class="row mt-4">
           <?php 
          $query_s= mysqli_query($db, "SELECT * FROM shareitem INNER JOIN useraccounts ON shareitem.userID=useraccounts.userID WHERE s_itemCat='Bukan Makanan';");
                                       ...
                                       <div class="card">
                                           <div class="card-body">
                                             <img class="p-0 m-0 mx-auto w-100" src="img/<?php echo $row_s['image']; ?>" style="height:250px">
                                               ...
                                               <p class="card-text"><strong>Dikongsi Oleh: </strong><br><?php echo $row_s["name"];?></br></p>
                                               <p class="card-text"><strong>Dikongsi Pada: </strong><br> <?php echo $row_s["s_date"];?></br></p>
