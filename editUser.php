            ...
            <div class="col-lg-6 m-auto">
                <div class="card mt-5">
                    <div class="card-title">
                        <h3 class="bg-success text-white-center py-3">
                            Kemas Kini Maklumat Pengguna
                        </h3>
                    </div>
                    <div class="card-body">
                    <form action="updateUser.php?ID=<?php echo $userID?>" method="POST">
                        <input type="text" class="form-control mb-2" placeholder="Nama" name="name"
                        value="<?php echo $name?>">
                        <input type="email" class="form-control mb-2" placeholder="Emel" name="email"
                        value="<?php echo $email?>">
                        <button class="btn btn-primary" name="update">Kemas Kini</button>
                        <a href="viewUser.php">Kembali</a>
                    </form>
                    </div>
                </div>
            </div>
