...
<section class="breadcrumbs">
 ...
 <div class="row mt-4">
           <?php 
          $query = mysqli_query($db, "SELECT * FROM shareitem INNER JOIN useraccounts ON shareitem.userID=useraccounts.userID WHERE s_itemCat='Makanan';");
...
<div class="row mt-4">
           <?php 
          $query_r = mysqli_query($db, "SELECT * FROM requestitem INNER JOIN useraccounts ON requestitem.userID=useraccounts.userID WHERE itemCat='Makanan';");
